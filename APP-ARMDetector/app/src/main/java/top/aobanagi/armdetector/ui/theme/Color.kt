package top.aobanagi.armdetector.ui.theme

import androidx.compose.ui.graphics.Color

// 基准颜色 #00ccaa
val Primary = Color(0xFF00CCAA)
val OriginalPrimaryLight = Color(0xFF64FFDA) // 重命名以避免冲突
val OriginalPrimaryDark = Color(0xFF009A7D) // 重命名以避免冲突

// 暗色主题颜色
val Primary80 = Color(0xFF64FFDA)
val Secondary80 = Color(0xFF4DD0E1)
val Tertiary80 = Color(0xFF80CBC4)

// 亮色主题颜色
val Primary40 = Color(0xFF00CCAA)
val Secondary40 = Color(0xFF00ACC1)
val Tertiary40 = Color(0xFF4DB6AC)

// 功能颜色
val TemperatureWarm = Color(0xFFF57C00)
val TemperatureCold = Color(0xFF0288D1)
val TemperatureNormal = Color(0xFF4CAF50)

val HumidityHigh = Color(0xFF4FC3F7)
val HumidityLow = Color(0xFFFFB74D)
val HumidityNormal = Color(0xFF4CAF50)

val CoDangerous = Color(0xFFE53935)
val CoWarning = Color(0xFFFFB74D)
val CoNormal = Color(0xFF4CAF50)

val DustDangerous = Color(0xFFE53935)
val DustWarning = Color(0xFFFFB74D)
val DustNormal = Color(0xFF4CAF50)

val AlarmCritical = Color(0xFFE53935)
val AlarmWarning = Color(0xFFFFB74D)
val AlarmNormal = Color(0xFF4CAF50)
